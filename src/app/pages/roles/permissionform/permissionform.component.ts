...
getPermissionsByRole(){
  this.roleService.getRole(this.roleId).subscribe(res=>{
    ...
    this.permissions = new Set<number>(res.permissions.map((prmss: any) => prmss.id))
  })
  ...
  savePermission(){
    this.roleService.setPermissions({
      ...
      this.toastService.success({detail: 'SUCCESS MESSAGE', summary: "Permission successfully saved"})
